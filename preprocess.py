    ...
    for paragraph in paragraphIter:
        ...
        for line in paragraph:
            ...
            if (len(parts) == 1):#context
                ...
                #make context into one long sequence with "." token after each sentence
                concatenatedContext = sum([sentence + [wordIndices['.']] for sentence in context], [])
                yield concatenatedContext, question, answer
